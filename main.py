...
def draw_score():
    ...
    time_text = points_text = font.render(f'Time Elapsed: {time_passed}', True, 'black')
    screen.blit(time_text, (320, 687))
    shots_text = font.render(f'Total Shots: {total_shots}', True, 'black')
    screen.blit(shots_text, (320, 714))
    if mode == 0:
...
while run:
    ...
    if level == 1:
        ...
        if shot:
            ...
            shot = False # Allow you to shoot one at a time instead being able to hold
    elif level == 2:
